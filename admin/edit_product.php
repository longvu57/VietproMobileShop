...
if(isset($_POST['sbm'])){
    ...
    if($_FILES['prd_image']['name']==''){
        ...
        move_uploaded_file($tmp_prd_image, "img/products/$prd_image");
    }
    ...
    $sql = "UPDATE product SET cat_id='$cat_id', prd_name='$prd_name', 
            prd_image='$prd_image', prd_price='$prd_price', 
            prd_warranty='$prd_warranty', 
            prd_accessories='$prd_accessories', prd_new='$prd_new', 
            prd_promotion='$prd_promotion', prd_status='$prd_status', 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <img width="150px" src="img/products/<?php echo $row['prd_image']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    ?>
                                        <option <?php if($row['cat_id']==$row_cat['cat_id']){echo 'selected';} ?> value=<?php echo $row_cat['cat_id']; ?>>
