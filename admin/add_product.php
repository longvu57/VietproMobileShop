...
if(isset($_POST['sbm'])){
    ...
    $sql = "INSERT INTO product(cat_id, prd_name, prd_image, 
            prd_price, prd_warranty, prd_accessories, prd_new, 
            prd_promotion, prd_status, prd_featured, prd_details) 
            VALUES('$cat_id','$prd_name','$prd_image','$prd_price',
            '$prd_warranty','$prd_accessories','$prd_new',
            '$prd_promotion','$prd_status','$prd_featured','$prd_details')";
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cat_id" class="form-control">
                                <?php   
                                    // hiển thị toàn bộ các danh mục để lựa chọn
