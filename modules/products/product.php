...
<div id="product">
    <div id="product-head" class="row">
        ...
        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul>
                ...
                {echo 'text-success';}else{echo 'text-danger';} ?>">
                    <?php  
                    if($row['prd_status']==1){
                        echo 'Còn hàng';
                    }else{
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO comment(prd_id, comm_name, comm_mail,
                comm_date, comm_details) VALUES('$prd_id','$comm_name',
                '$comm_mail','$comm_date','$comm_details')";
    ...
    <div id="comments-list" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
        <?php while($row_comm = mysqli_fetch_array($query_comm)){ ?>
